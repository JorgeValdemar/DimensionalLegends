...
{
    /// <summary>
    /// Summary description for LerPlayerCards
    /// </summary>
    public class LerPlayerCards : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("get_player_cards", conex);
